...
{
  // Model step function
  float SpeedControl::step(float arg_Speed_ref, float arg_Real_Speed, float
    &arg_Speed_Error)
  {
    float Integrator;
  ...
  void SpeedControl::initialize()
  {
    // (no initialization code required)
  }

  // Model terminate function
  void SpeedControl::terminate()
  {
  ...
  SpeedControl::~SpeedControl() = default;
}
